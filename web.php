...
Route::group(['prefix' => 'admin', 'middleware' => ['verified', 'role:admin', 'PreventBackHistory']], function() {
        ...
        Route::get('/stt/results/live', [AdminSTTController::class, 'listLiveResults'])->name('admin.stt.results.live');
        Route::post('/stt/results/transcript', [AdminSTTController::class, 'transcript']);
        Route::post('/stt/results/transcript/save', [AdminSTTController::class, 'transcriptSave']);
        ...
        Route::get('/stt/languages', [AdminSTTController::class, 'languages'])->name('admin.stt.languages');
        Route::post('/stt/languages/{id}/update', [AdminSTTController::class, 'languageUpdate'])->name('admin.stt.languages.update');
        Route::get('/stt/languages/{id}/edit', [AdminSTTController::class, 'languageEdit'])->name('admin.stt.languages.edit');
        Route::post('/stt/languages/{id}/activate', [AdminSTTController::class, 'languageActivate'])->name('admin.stt.languages.activate');
        Route::get('/stt/languages/{id}/activate', [AdminSTTController::class, 'languageShowActivate'])->name('admin.stt.languages.activate.show');
        Route::get('/stt/languages/activate/all', [AdminSTTController::class, 'languagesActivateAll'])->name('admin.stt.languages.activate.all');
        Route::delete('/stt/languages/{id}/deactivate', [AdminSTTController::class, 'languageDeactivate'])->name('admin.stt.languages.deactivate');
        Route::get('/stt/languages/{id}/deactivate', [AdminSTTController::class, 'languageShowDeactivate'])->name('admin.stt.languages.deactivate.show');
        Route::get('/stt/languages/deactivate/all', [AdminSTTController::class, 'languagesDeactivateAll'])->name('admin.stt.languages.deactivate.all');
...
Route::group(['prefix' => 'user', 'middleware' => ['verified', 'role:user|admin|subscriber', 'PreventBackHistory']], function() {
        ...
        Route::get('/stt/settings/live', [STTController::class, 'settingsLive']);
        Route::get('/stt/settings/live/limits', [STTController::class, 'settingsLiveLimits']);
        ...
        Route::get('/stt/results/live', [STTResultController::class, 'live'])->name('user.stt.results.live');
        ...
        Route::post('/stt/result/transcript', [STTResultController::class, 'transcript']);
        Route::post('/stt/result/transcript/save', [STTResultController::class, 'transcriptSave']);
        Route::post('/stt/results/transcript/live', [STTResultController::class, 'transcript']);
        Route::post('/stt/results/transcript/save', [STTResultController::class, 'transcriptSave']);
        ...
        Route::get('/stt/live', [STTController::class, 'liveTranscribe'])->name('user.stt.live');
        Route::post('/stt', [STTController::class, 'transcribe'])->name('user.stt.transcribe');
        Route::post('/stt/transcribe/live', [STTController::class, 'transcribeLive'])->name('user.stt.transcribe.live');
